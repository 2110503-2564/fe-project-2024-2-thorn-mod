    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center space-y-5">
        ...
        <h3 className="text-white text-lg max-w-2xl">
          Welcome to Restaurant Reservation Discover your favorite restaurants
          and book a table in just a few clicks. No more waiting in lines — make
          every meal memorable.
        </h3>
        <SearchBar />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-5 py-5 place-items-center">
          <button
